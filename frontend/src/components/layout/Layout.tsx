...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Teachers', to: '/app/teachers', icon: Chalkboard },
      { label: 'Subjects', to: '/app/subjects', icon: BookBookmark },
      { label: 'Attendance', to: '/app/attendance', icon: ClipboardText },
      ...
      { label: 'Credit Notes', to: '/app/credit-notes', icon: ReceiptX },
      { label: 'Receipts', to: '/app/receipts', icon: Receipt },
      { label: 'Payment Intents', to: '/app/payment-intents', icon: HandCoins },
      { label: 'Bursaries', to: '/app/bursaries', icon: HandHeart },
    ],
  },
  {
    label: 'Accounting',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Requisitions', to: '/app/requisitions', icon: ListChecks },
      { label: 'Stock Lots', to: '/app/stock-lots', icon: Stack },
      { label: 'Low Stock', to: '/app/low-stock', icon: TrendDown },
    ],
  },
  {
    label: 'Purchasing',
