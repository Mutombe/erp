...
import { PageHeader, RefreshingOverlay, SkeletonCard, StatusBadge, refreshingContentClass } from '@/components/ui'
...
export default function SupplierPaymentDetail() {
  ...
  const isRefreshing = isFetching && !!payment

  if (!payment) return <SkeletonCard />
